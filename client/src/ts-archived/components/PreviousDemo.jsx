            ...
            <BrowserRouter>
                <div>
                    <ul>
                        ...
                        <NavLink to='/demo/previous-demo/candidates'>Candidates</NavLink>
                        <NavLink to='/demo/previous-demo/locations'>Locations</NavLink>
                        <NavLink to='/demo/previous-demo/questions'>Questions</NavLink>
                    </ul>
                </div>
                <main>
                    <Switch>
                        <Route exact path='/demo/previous-demo' component={PreviousDemoMenu} />
                        <Route path='/demo/previous-demo/candidates' component={CandidateMenu} />
                        <Route path='/demo/previous-demo/locations' component={LocationMenu} />
                        <Route path='/demo/previous-demo/questions' component={QuestionsMenu} />
                    </Switch>
                </main>
            </BrowserRouter>
        </SectionContainer>
